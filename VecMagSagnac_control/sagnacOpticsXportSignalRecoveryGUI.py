...
from sagnac.procedures import sagnacOpticsXportSignalRecoveryProcedure_vm

class sagnacOpticsXportSignalRecoveryGUI(ManagedWindow):

    SWEEP_PARAM_NAMES = ['sweep_field', 'sweep_field_azimuth']
    NUM_SWEEP_PARAMS = len(SWEEP_PARAM_NAMES)

    def __init__(self):
        super(sagnacOpticsXportSignalRecoveryGUI, self).__init__(
            procedure_class=sagnacOpticsXportSignalRecoveryProcedure_vm,
            displays=[
                'sample_name',
                'current_frequency',
                'amp_gain',
    ...
    def make_procedure(self):
        ...
        """
        procedure = sagnacOpticsXportSignalRecoveryProcedure_vm()
...
if __name__ == '__main__':
    ...
    window = sagnacOpticsXportSignalRecoveryGUI()
    window.show()
    sys.exit(app.exec_())
