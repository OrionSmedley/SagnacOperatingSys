...
from sagnac.procedures import sagnacHeterodyneProcedure_vm_highZ
...
class sagnacHeterodyneGUI(ManagedWindow):
    ...
    def __init__(self):
        super(sagnacHeterodyneGUI, self).__init__(
            procedure_class=sagnacHeterodyneProcedure_vm_highZ,
            displays=[
                'sample_name',
                'applied_current',
                'amp_gain',
        ...
        self.setWindowTitle('PyMeasure Sagnac Heterodyne High Z Hysteresis Scan')
    ...
    def _setup_ui(self):
        ...
        self.inputs = fromUi(os.path.join(self.run_directory,'custom_inputs/sagnac_gui_Heterodyne_HighZ.ui'))
    ...
    def make_procedure(self):
        ...
        """
        procedure = sagnacHeterodyneProcedure_vm_highZ()
    ...
    def queue(self):
        ...
        for procedure in procedures:
            ...
            pre = procedure.sample_name + \
                '_SagnacHeterodyne_I{current:0.4f}A_A{azimuth:0.1f}_step{step}_x{delta_x}_y{delta_y}_'.format(
