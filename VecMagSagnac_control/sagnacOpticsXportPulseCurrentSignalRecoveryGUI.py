...
from sagnac.procedures import sagnacOpticsXportPulseCurrentSignalRecoveryProcedure_vm

class sagnacOpticsXportPulseCurrentSignalRecoveryGUI(ManagedWindow):

    SWEEP_PARAM_NAMES = ['sweep_field', 'sweep_field_azimuth']
    NUM_SWEEP_PARAMS = len(SWEEP_PARAM_NAMES)

    def __init__(self):
        super(sagnacOpticsXportPulseCurrentSignalRecoveryGUI, self).__init__(
            procedure_class=sagnacOpticsXportPulseCurrentSignalRecoveryProcedure_vm,
            displays=[
                'sample_name',
                'current_frequency',
                'amp_gain',
        ...
        self.setWindowTitle('PyMeasure Sagnac Vector Magnet Optics Xport Combo Pulse Current Signal Recovery Scan')
    ...
    def _setup_ui(self):
        ...
        """
        super(sagnacOpticsXportPulseCurrentSignalRecoveryGUI, self)._setup_ui()
        self.inputs.hide()
    ...
    def make_procedure(self):
        ...
        """
        procedure = sagnacOpticsXportPulseCurrentSignalRecoveryProcedure_vm()
...
if __name__ == '__main__':
    ...
    window = sagnacOpticsXportPulseCurrentSignalRecoveryGUI()
    window.show()
    sys.exit(app.exec_())
