...
from sagnac.procedures import sagnacOpticsXportSignalRecoveryProcedure_vm_highZ

class sagnacOpticsXportHighZSignalRecoveryGUI(ManagedWindow):

    SWEEP_PARAM_NAMES = ['sweep_field', 'sweep_field_azimuth']
    NUM_SWEEP_PARAMS = len(SWEEP_PARAM_NAMES)

    def __init__(self):
        super(sagnacOpticsXportHighZSignalRecoveryGUI, self).__init__(
            procedure_class=sagnacOpticsXportSignalRecoveryProcedure_vm_highZ,
            displays=[
                'sample_name',
                'current_frequency',
                'amp_gain',
        ...
        self.setWindowTitle('PyMeasure Sagnac Vector Magnet Optics Xport Combo Signal Recovery Scan')
    ...
    def _setup_ui(self):
        ...
        """
        super(sagnacOpticsXportHighZSignalRecoveryGUI, self)._setup_ui()
        self.inputs.hide()
    ...
    def make_procedure(self):
        ...
        """
        procedure = sagnacOpticsXportSignalRecoveryProcedure_vm_highZ()
...
if __name__ == '__main__':
    ...
    window = sagnacOpticsXportHighZSignalRecoveryGUI()
    window.show()
    sys.exit(app.exec_())
