...
from scanning.procedures import XYScanProcedure

import send_gmail

class XYScanProcedureGUI(ManagedWindow):

	def __init__(self):
		super(XYScanProcedureGUI, self).__init__(
			procedure_class=XYScanProcedure,
			displays=[
				'sample_name',
				'x_start',
				'y_start',
	...
	def _setup_ui(self):
		...
		"""
		super(XYScanProcedureGUI, self)._setup_ui()
		self.inputs.hide()
