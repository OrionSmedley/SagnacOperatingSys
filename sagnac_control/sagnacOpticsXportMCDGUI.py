...
from sagnac.procedures import sagnacOpticsXportMCDProcedure

class sagnacOpticsXportMCDGUI(ManagedWindow):

    SWEEP_PARAM_NAMES = ['sweep_field', 'sweep_field_azimuth']
    NUM_SWEEP_PARAMS = len(SWEEP_PARAM_NAMES)

    def __init__(self):
        super(sagnacOpticsXportMCDGUI, self).__init__(
            procedure_class=sagnacOpticsXportMCDProcedure,
            displays=[
                'sample_name',
                'current_frequency',
                'amp_gain',
        ...
        self.setWindowTitle('PyMeasure Sagnac Optics Xport MCD Combo Scan')
    ...
    def _setup_ui(self):
        ...
        """
        super(sagnacOpticsXportMCDGUI, self)._setup_ui()
        self.inputs.hide()
    ...
    def make_procedure(self):
        ...
        """
        procedure = sagnacOpticsXportMCDProcedure()
...
if __name__ == '__main__':
    ...
    window = sagnacOpticsXportMCDGUI()
    window.show()
    sys.exit(app.exec_())
