...
class Hall2HarmAngProcedure_highFreq(Procedure):
    """
    ...
    def startup(self):
        ...
        self.lockin1.reference = 'external front'
        self.lockin1.voltage_input_device = 'FET'
        self.lockin1.input_coupling = 'AC'
...
class Hall2HarmFieldProcedure_highFreq(Procedure):
    """
    Procedure for taking second harmonic Hall Measurements with the Daedalus setup,
    ...
    def startup(self):
       ...
       # Lockin measuring first harmonic
        ...
        self.lockin2.harmonic = 2
        self.lockin2.reference = 'internal'
        self.lockin2.frequency = 1713.00
        self.lockin2.phase = 90. # second harmonic is cos(2wt)
