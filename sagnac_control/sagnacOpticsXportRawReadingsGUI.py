...
from sagnac.procedures import sagnacOpticsXportRawReadingsProcedure

class sagnacOpticsXportRawReadingsGUI(ManagedWindow):

    SWEEP_PARAM_NAMES = ['sweep_field', 'sweep_field_azimuth']
    NUM_SWEEP_PARAMS = len(SWEEP_PARAM_NAMES)

    def __init__(self):
        super(sagnacOpticsXportRawReadingsGUI, self).__init__(
            procedure_class=sagnacOpticsXportRawReadingsProcedure,
            displays=[
                'sample_name',
                'current_frequency',
                'amp_gain',
        ...
        self.setWindowTitle('PyMeasure Sagnac Optics Xport Raw Readings Combo Scan')
    ...
    def _setup_ui(self):
        ...
        """
        super(sagnacOpticsXportRawReadingsGUI, self)._setup_ui()
        self.inputs.hide()
    ...
    def make_procedure(self):
        ...
        """
        procedure = sagnacOpticsXportRawReadingsProcedure()
...
if __name__ == '__main__':
    ...
    window = sagnacOpticsXportRawReadingsGUI()
    window.show()
    sys.exit(app.exec_())
