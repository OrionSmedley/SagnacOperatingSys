...
try: #TM-620
    ...
    #   TM620.Tmag reads the magnet temperature and returns a float
    #   TM620.Tshield reads the shield temperature and returns a float
    
except:
    print("sagnac4.0: no TM620")
...
try: #LK336
    ...
    import numpy as np
    import pandas as pd
    from aparatus.drivers import Lakeshore336
    LK336 = Lakeshore336.Lakeshore336()
    
except:
    print("sagnac4.0: no LK336")
...
try: # Magnet High Z
    ...
    print("sagnac4.0: no magnet highZ")
